...
function patchOptional(path, oldText, newText, label){
  let s=fs.readFileSync(path,'utf8');
  if(s.includes(newText)){console.log(`V101 ${label}: already applied`);return;}
...
// Sponsored AdsGram task UI can be intentionally absent. If it exists, keep its
// callback-race hardening; if removed, do not fail the entire production build.
