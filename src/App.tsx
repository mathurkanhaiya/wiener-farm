...
function App(){
 ...
 const runFarm=async(action:string,b:any={},ok='Done')=>{if(action!=='farm_claim')return run(action,b,ok);if(!data)return;setFarmClaimOpen(true)};
